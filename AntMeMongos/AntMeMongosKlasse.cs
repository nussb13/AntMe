...
namespace AntMe.Player.AntMeMongos
{
    /// <summary>
    ...
    /// </summary>
    [Spieler(
        Volkname = "AntMeMongos",   // Hier kannst du den Namen des Volkes festlegen
        Vorname = "Hans",       // An dieser Stelle kannst du dich als Schöpfer der Ameise eintragen
        Nachname = "Peter"       // An dieser Stelle kannst du dich als Schöpfer der Ameise eintragen
    )]
    ...
    public class AntMeMongosKlasse : Basisameise
    {
        #region Kasten
